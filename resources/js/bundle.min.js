...
/***/ "./app/blocks/accordion/accordion.js":
/*!*******************************************!*\
  !*** ./app/blocks/accordion/accordion.js ***!
  \*******************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction Accordion(accordionElement) {\n  var _this = this;\n\n  if (!accordionElement) return;\n  this.accordion = accordionElement;\n  this.selectors = {\n    toggle: 'accordion__header',\n    body: 'accordion__body',\n    toOpen: 'is-open'\n  };\n  this.resizeHandlerEnable = false;\n  this.currentAccordion = null;\n  this.bodyCurrentAccordion = null;\n\n  this.showBodyAccordion = function (node) {\n    var element = node;\n    element.style.height = \"\".concat(element.scrollHeight, \"px\");\n    return element;\n  };\n\n  this.hideBodyAccordion = function (node) {\n    var element = node;\n    element.style.height = null;\n    return element;\n  };\n\n  this.resize = function () {\n    _this.showBodyAccordion(_this.bodyCurrentAccordion);\n  };\n\n  this.clickHandler = function (e) {\n    var target = e.target; // Если клик не по переключателю, ничего не делаем\n\n    var clickOnToggle = target.classList.contains(_this.selectors.toggle);\n    if (!clickOnToggle) return;\n    e.preventDefault(); // Получим текущий Аккордеон\n\n    _this.currentAccordion = target.parentElement; // Переключим css-класс открыт/закрыт\n\n    _this.currentAccordion.classList.toggle(_this.selectors.toOpen); // Получим тело Аккордеона\n\n\n    _this.bodyCurrentAccordion = _this.currentAccordion.querySelector(\".\".concat(_this.selectors.body)); // Скроем или отобразим тело изменив высоту\n\n    if (_this.bodyCurrentAccordion.style.height) {\n      _this.hideBodyAccordion(_this.bodyCurrentAccordion); // Аккордион закрыт, удалим обработчик на resize окна\n\n\n      window.removeEventListener('resize', _this.resize, false);\n    } else {\n      _this.showBodyAccordion(_this.bodyCurrentAccordion); // Аккордион открыт, назначим обработчик на resize окна\n\n\n      window.addEventListener('resize', _this.resize, false);\n    }\n  };\n\n  this.accordion.addEventListener('click', this.clickHandler);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Accordion);\n\n//# sourceURL=webpack:///./app/blocks/accordion/accordion.js?");

/***/ }),

/***/ "./app/blocks/main-menu/dropdown-menu.js":
/*!***********************************************!*\
  !*** ./app/blocks/main-menu/dropdown-menu.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar dropDownMenu = function dropDownMenu() {\n  var classNames = {\n    dropdownMenu: 'js-dropdown-menu',\n    menuItem: 'main-menu__item',\n    menuLink: 'main-menu__link',\n    itemIsOpend: 'is-opend',\n    itemHasSubMenu: 'has-submenu'\n  };\n  var menu = document.querySelector(\".\".concat(classNames.dropdownMenu));\n\n  if (!menu) {\n    console.warn(\"Can't find element \".concat(classNames.dropdownMenu, \"!\"));\n    return;\n  }\n\n  var items = menu.querySelectorAll(\".\".concat(classNames.menuItem)); // Установим метку если пункт меню имеет подменю\n\n  items.forEach(function (item) {\n    if (item.children.length > 1) {\n      item.classList.add(classNames.itemHasSubMenu);\n    }\n  });\n\n  var onClickMenu = function onClickMenu(menuItem) {\n    // Если у пункта нет подменю, выйдем из программы\n    if (!menuItem.classList.contains(classNames.itemHasSubMenu)) {\n      return;\n    } // Если кликнули на открытый пункт, просто закроем его и выйдем из программы\n\n\n    if (menuItem.classList.contains(classNames.itemIsOpend)) {\n      menuItem.classList.remove(classNames.itemIsOpend);\n      return;\n    } // Закроем все открытые\n\n\n    items.forEach(function (item) {\n      if (item.classList.contains(classNames.itemIsOpend)) {\n        item.classList.remove(classNames.itemIsOpend);\n      }\n    }); // Откроем пункт по которому кликнули\n\n    menuItem.classList.add(classNames.itemIsOpend);\n  };\n\n  menu.addEventListener('click', function (_ref) {\n    var target = _ref.target;\n\n    // Вызвать обработчик только если кликнули по ссылке\n    if (target.classList.contains(classNames.menuLink)) {\n      var menuItem = target.closest(\".\".concat(classNames.menuItem));\n      onClickMenu(menuItem);\n    }\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (dropDownMenu);\n\n//# sourceURL=webpack:///./app/blocks/main-menu/dropdown-menu.js?");

/***/ }),

/***/ "./app/blocks/main-nav/main-nav.js":
/*!*****************************************!*\
  !*** ./app/blocks/main-nav/main-nav.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar MainNav = function MainNav() {\n  var selectors = {\n    menu: '.js-main-menu',\n    openBtn: '.js-main-menu-open-btn',\n    closeBtn: '.js-main-menu-close-btn'\n  };\n  var menu = document.querySelector(selectors.menu);\n  var openBtn = document.querySelector(selectors.openBtn);\n  var closeBtn = document.querySelector(selectors.closeBtn);\n  var htmlElement = document.documentElement;\n  if (!menu || !openBtn) return;\n\n  var openMenu = function openMenu(event) {\n    event.preventDefault();\n    menu.classList.add('is-opend');\n    htmlElement.classList.add('menu-opend');\n  };\n\n  var closeMenu = function closeMenu(event) {\n    event.preventDefault();\n    menu.classList.remove('is-opend');\n    htmlElement.classList.remove('menu-opend');\n  };\n\n  openBtn.addEventListener('click', openMenu);\n  closeBtn.addEventListener('click', closeMenu);\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (MainNav);\n\n//# sourceURL=webpack:///./app/blocks/main-nav/main-nav.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var svg4everybody__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svg4everybody */ \"./node_modules/svg4everybody/dist/svg4everybody.js\");\n/* harmony import */ var svg4everybody__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(svg4everybody__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var easydropdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! easydropdown */ \"./node_modules/easydropdown/dist/index.js\");\n/* harmony import */ var easydropdown__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(easydropdown__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _blocks_main_menu_dropdown_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../blocks/main-menu/dropdown-menu */ \"./app/blocks/main-menu/dropdown-menu.js\");\n/* harmony import */ var _blocks_main_nav_main_nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../blocks/main-nav/main-nav */ \"./app/blocks/main-nav/main-nav.js\");\n/* harmony import */ var _blocks_accordion_accordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../blocks/accordion/accordion */ \"./app/blocks/accordion/accordion.js\");\n/* eslint-disable no-new */\n\n\n\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  svg4everybody__WEBPACK_IMPORTED_MODULE_0___default()();\n  Object(_blocks_main_nav_main_nav__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  Object(_blocks_main_menu_dropdown_menu__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  var accordions = document.querySelectorAll('.accordion');\n\n  if (accordions.length) {\n    [].map.call(accordions, function (el) {\n      return new _blocks_accordion_accordion__WEBPACK_IMPORTED_MODULE_4__[\"default\"](el);\n    });\n  }\n\n  var formSelects = document.querySelectorAll('.form-field select');\n\n  if (formSelects.length) {\n    formSelects.forEach(function (element) {\n      easydropdown__WEBPACK_IMPORTED_MODULE_1___default()(element, {\n        classNames: {\n          root: 'edd-root form-field__input'\n        }\n      });\n    });\n  }\n});\n\n//# sourceURL=webpack:///./app/scripts/app.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar Callbacks = /** @class */ (function () {\n    function Callbacks() {\n        this.onOpen = null;\n        this.onClose = null;\n        this.onSelect = null;\n        this.onOptionClick = null;\n        Object.seal(this);\n    }\n    return Callbacks;\n}());\nexports.default = Callbacks;\n//# sourceMappingURL=Callbacks.js.map\n\n//# sourceURL=webpack:///./node_modules/easydropdown/dist/Config/Callbacks.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar cache = [];\nexports.default = cache;\n//# sourceMappingURL=cache.js.map\n\n//# sourceURL=webpack:///./node_modules/easydropdown/dist/Easydropdown/cache.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.UP = 38;\nexports.DOWN = 40;\nexports.SPACE = 32;\nexports.ENTER = 13;\nexports.ESC = 27;\n//# sourceMappingURL=KeyCodes.js.map\n\n//# sourceURL=webpack:///./node_modules/easydropdown/dist/Events/Constants/KeyCodes.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.OPTION = '[data-ref~=\"option\"]';\n//# sourceMappingURL=Selectors.js.map\n\n//# sourceURL=webpack:///./node_modules/easydropdown/dist/Events/Constants/Selectors.js?");
...
eval("if (!Element.prototype.matches) {\n    Element.prototype.matches = Element.prototype.msMatchesSelector;\n}\n//# sourceMappingURL=Element.matches.js.map\n\n//# sourceURL=webpack:///./node_modules/easydropdown/dist/Shared/Polyfills/Element.matches.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar Option = /** @class */ (function () {\n    function Option() {\n        this.label = '';\n        this.value = '';\n        this.isDisabled = false;\n    }\n    return Option;\n}());\nexports.default = Option;\n//# sourceMappingURL=Option.js.map\n\n//# sourceURL=webpack:///./node_modules/easydropdown/dist/State/Option.js?");
