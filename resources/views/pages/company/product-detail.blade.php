...
<section class="section">
    <div class="content-container">
      <div class="breadcrumbs"><a class="breadcrumbs__item" href="#0">Главная</a><a class="breadcrumbs__item" href="#0">Каталог</a><a class="breadcrumbs__item">Phillips 3.0T Achieva Mri.</a></div>
    </div>
  </section>
  <section class="section">
    <div class="product-detail">
      <div class="product-detail__main content-container layout layout_screen-tablet_40-60">
        <div class="product-detail__main-content">
          <h1 class="product-detail__title">Phillips 3.0T Achieva Mri.</h1><span class="product-detail__price">35,5 млн.рублей</span><span class="product-detail__state">Первичная установка 2010 год.</span>
        ...
        <div class="product-detail__main-visual"><img src="/assets/img/demo-image.jpg" alt=""></div>
      </div>
    </div>
  </section>
  <section class="section">
